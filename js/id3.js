...
var prediksi = function(samples,$el,model,target,features){
  ...
  {
    var info = "Diaporthe Stem Canker<br> <li> diatasi dengan efektif dengan mengkombinasikan tanaman yang resistant </li> <br><li> mengurangi tanaman yang tumbuh dipermukaan </li> <br> <li> jika akan menanam kembali harus dicermati benihnya jangan sampai dari yang terjangkit stem canker </li> <br>";
  }

  // swal(predict(model, s) , aaa, "success");
  swal({   title: 'Hasil : '+"<span style='color:#1abc9c'>"+predict(model, s)+"</span>",   text: "<b>Cara Penanganan</b> : <br><br>"+info,  html: true, type: "success", confirmButtonColor: "#1abc9c",   confirmButtonText: "OK",   closeOnConfirm: false }, function(){   location.replace("index.php");});
